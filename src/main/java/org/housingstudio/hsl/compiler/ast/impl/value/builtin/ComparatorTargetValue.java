...
public class ComparatorTargetValue extends Value {
    private final @NotNull ComparatorTarget comparatorTarget;
    ...
    public @NotNull BaseType getValueType() {
        return BaseType.COMPARATOR_TARGET;
    }
    ...
    public @NotNull String asConstantValue() {
        return comparatorTarget.format();
    }
    ...
    public @NotNull String print() {
        return "ComparatorTarget::" + comparatorTarget.format();
    }
}
