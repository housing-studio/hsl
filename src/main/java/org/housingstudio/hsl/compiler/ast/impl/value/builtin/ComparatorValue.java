...
public class ComparatorValue extends Value {
    private final @NotNull Comparator comparator;
    ...
    public @NotNull String print() {
        return "Comparator::" + comparator.format();
    }
}
