...
public class ItemComparatorValue extends Value {
    private final @NotNull ItemComparator itemComparator;
    ...
    public @NotNull BaseType getValueType() {
        return BaseType.ITEM_COMPARATOR;
    }
    ...
    public @NotNull String print() {
        return "ItemComparator::" + itemComparator.format();
    }
}
