...
public class ComparatorAmountValue extends Value {
    private final @NotNull ComparatorAmount comparatorAmount;
    ...
    public @NotNull BaseType getValueType() {
        return BaseType.COMPARATOR_AMOUNT;
    }
    ...
    public @NotNull String asConstantValue() {
        return comparatorAmount.format();
    }
    ...
    public @NotNull String print() {
        return "ComparatorAmount::" + comparatorAmount.format();
    }
}
